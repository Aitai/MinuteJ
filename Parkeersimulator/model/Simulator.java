...
public class Simulator extends ViewModel implements Runnable {
     ...
     * Rondt een double af
     *
     * @param value  De waarde van het getal
     * @param places Het decimaal waarop afgerond moet worden
     * @return
     */
     ...
     *
     * @param queue De rij waarvan de auto gehaald moet worden
     */
